...
def iterate_pumping_rate_transient(setup_file, model_file, mlibs_path, output_dir, results_dir, model_ws_name, 
    ...
    Args:
        ...
        output_dir (str): Directory where output files from model iterations will be saved.
        results_dir (str): Directory where summary of results will be saved.
