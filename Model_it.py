...
cb = flopy.utils.CellBudgetFile(budget_file_path)
...
if response_times:
    ...
    print(f"Pumping rate [m3/day]: {q0}",
            ...
            f"tr_max_rel_local= {tr_max_rel_local}", sep="\n"
            )
...
if animate:
    # modplot6.plot_animation(gwf, transient_heads, nrow//2, times_list,
    ...
    #                             surface = True, layers=False,
    #                             show=False, save=True, figsize = (19, 4), 
    #                             gif_start=start_step, gif_step=20, duration=250)
